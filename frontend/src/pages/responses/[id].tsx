...
export default function UserResponseViewPage() {
  ...
  const handleDeleteResponse = () => {
    if (confirm(`Are you sure you want to delete your response to "${response?.form.title}"? This action cannot be undone.`)) {
        ...
        >
          <div style={{
            ...
            <h2 style={{
              ...
              My Answers ({response.answers.length})
            </h2>
          </div>
